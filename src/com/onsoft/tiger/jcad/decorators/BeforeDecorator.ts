...
/**
 * The <code>BeforeDecorator</code> class defines the <code>Decorator</code>  
 * implementation for the JUTA <code>@Before</code> decorator.
 */
export class BeforeDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>BeforeDecorator</code> instance.
   */
  constructor() {}
  ...
  public decorate(target:any, key:string, descriptor:PropertyDescriptor,
    ...
    let methodDescriptor:AnnotatedMethodDescriptor =
             builder.build(key, descriptor, AnnotatedMethodType.BEFORE, params);
